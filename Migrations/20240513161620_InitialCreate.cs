        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentHash = table.Column<byte[]>(type: "varbinary(64)", maxLength: 64, nullable: false),
                    CurrentSalt = table.Column<byte[]>(type: "varbinary(64)", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Hash = table.Column<byte[]>(type: "varbinary(64)", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoleUser_AspNetUserRoles_RoleId_UserId",
                        columns: x => new { x.RoleId, x.UserId },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Devivered = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2d0e7deb-2739-49aa-b6b1-40a56052de12", null, "Admin", "ADMIN" },
                    { "3e08b728-ffa2-4edb-bbbe-83a333d1ea2e", null, "Producer", "PRODUCER" },
                    { "dc5ade6c-9d54-4c54-873f-40cabf1b19e1", null, "User", "USER" }
                });
